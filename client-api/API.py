...
def search():
    if request.method == 'POST':
        data = request.get_json()
        conn = mysql.connect()
        search_params = {"user_token": False, "user_name": False, "creation_date_low": False,
                         "creation_date_high": False, "is_food": False}
        if "user_token" in data:
        ...
        result = foodie_db.search(conn, search_params["user_token"], search_params["user_name"],
                                  search_params["creation_date_low"], search_params["creation_date_high"],
                                  search_params["is_food"])
